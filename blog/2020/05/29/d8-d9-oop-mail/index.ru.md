...
- Возможность отправлять в качестве содержимого
  письма [рендер массивы](/blog/210).
...
- `array $body`: [Рендер массив](/blog/210) с телом письма. Мы будем отсылать
  письма именно через рендер массивы. Это открывает множество возможностей,
  например, формирование письма через [hook_theme()](/blog/151).

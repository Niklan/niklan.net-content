...
Преобразовывать или выдерать из текста для каких-то иных целей. В Drupal для
...
Вот и всё. Так вот просто объявляется фильтр в Drupal 8, впрочем, как и в Drupal
7. Только сделано это намного удобнее, хранится в одном файле и все разложено по
полочкам.

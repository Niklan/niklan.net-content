...
description: 'Программное создание блоков в Drupal 8.'
attachments:
  -
    name: 'Базовый модуль'
...
Давайте рассмотрим некоторые методы которые мы можем, должны и будем использовать, разумеется не все, но самые интересные и востребованные. Все методы BlockBase вы можете [посмотреть на drupal.org](https://api.drupal.org/api/drupal/core!lib!Drupal!Core!Block!BlockBase.php/class/BlockBase/8).
...
В данном примере я расскажу как создать самый простой блок, лишь минимум из минимумов, который будет выводить простой текст. Для старта можете воспользоваться [голой заготовкой модуля](/sites/default/files/blog/75/attachments/helloworld_blockapi_start.tar.gz).
...
![Наш блок в административном интерфейсе](image/1%20(31).png)

И если мы разместим блок, то увидим следующее.

![Наш первый блок](image/2%20(28).png)
...
![Настройки нашего блока](image/3%20(22).png)

И на выходе мы получаем:

![Результат](image/4%20(21).png)

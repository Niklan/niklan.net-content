...
меня уже есть статья [Drupal 8: Изменения API](/blog/64), где у меня в виде
сравнения показано как было и как стало. Там, кстати, данная тема также была
задета краешком глаза.
...
по [созданию hello world модуля в Drupal 8](/blog/66), или прямо

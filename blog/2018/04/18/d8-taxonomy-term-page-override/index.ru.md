...
одновременно: [Route Subscriber][d8-route-subscriber],
[hook_theme()][d8-hook-theme] и чутка [кэширование][d8-cache-metadata].
...
связать. На помощь нам приходит [Route Subscriber][d8-route-subscriber]. При помощи него,
...
Тут мы уже подключим [hook_theme()][d8-hook-theme]. Мы объявим собственный theme

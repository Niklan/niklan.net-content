...
a. `Cookie`: Авторизация посредством Cookie файла. Все очень просто. При
...
b. `Basic auth`: Авторизация при помощи пары логин-пароль. Отсылается вместе с
...
1.2 **Method**: Настройки будут для каждого метода индивидуальные. Например, вы

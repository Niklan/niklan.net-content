...
![](https://www.youtube.com/watch?v=jo-kWx6ujf0)
...
- [**Composer Drupal Project**](https://github.com/drupal-composer/drupal-project) — установка и управления ядром полностью через composer.
...
1. Заходите на [страницу проекта](https://github.com/drupal-composer/drupal-project).
...
_Лучше посмотреть видео, где это продемонстрировано наглядно. Таймкоды: 52:02 и 1:02:29._

...
Middleware является обычным [сервисом](/blog/150) (читай объектом), который
...
стоит обратить внимание на `KernelEvents` и использовать [Events](/blog/170)
вместо посредника.
...
ставятся **исключительно** [композером](/blog/130), без него пример не
реализовать.

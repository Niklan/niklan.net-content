...
импорт [users.csv](attachment/users.csv) и
[articles.csv](attachment/articles.csv) и расположил их в папке модуля assets.
Таким образом они доступы по пути /modules/custom/dummy/assets/users.csv и
articles.csv.

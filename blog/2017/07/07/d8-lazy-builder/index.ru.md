...
* `#lazy_builder`: Это фундамент всего и вся в данном материале, без него ничего
  ...
  * **Первый аргумент**: метод который будет обрабатывать логику для рендера.
    ...
    помощи [сервиса](/blog/150): `mymodule.my_renderer:renderContent`. Второй
...
реальности. Для этого мы объявим свой [theme hook](/blog/151) который будет
...
и [объявлять как сервис](/blog/150).

...
description: >-
  В этом материале я расскажу как создавать свои собственные типы полей. Это
  очень полезно если вам не хватает стандартного набора и решение отсутствует
  на drupal.org
attachments:
...
Самый простой шаг, мы должны сообщить Drupal о нашем модуле, поэтому объявляем

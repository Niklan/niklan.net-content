...
description: >-
  В этой статье я расскажу, как улучшить стандартный модуль для контактных форм
  Contact: без кода управлять его поведением, добавить возможность сохранения
  отправленных писем и отправлять их в формате HTML.

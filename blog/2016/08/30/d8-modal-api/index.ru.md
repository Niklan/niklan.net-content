...
description: >-
  В этом материале я расскажу вам как вызывать модальные окна при помощи
  встроенного в Drupal 8 API. Это поможет выводить формы, содержимое, да что
  угодно где угодно, и когда угодно в модальном (диалоговом) окне.
attachments:

...
выполнение [очередей](/blog/79) в cron операциях. Данный тип плагина
...
из-за Dependency Injection [сервисов](/blog/150).
...
использовать [Batch API](/blog/192), который требует участия юзера, то данный
